...
questions = [
    ...
    {
        title: 'Термин "наследование" обозначает, что...',
        buttons: [
            [{text: 'В производных классах присутствует часть состояния родительского класса.', callback_data: '1_1'}],
            [{text: 'Производные классы содержат поля и методы родительского.', callback_data: '1_2'}],
            [{text: 'Производные классы содержат методы родительского класса.', callback_data: '1_3'}],
            [{text: 'Производные классы наследуют поля родительского класса.', callback_data: '1_4'}],
            [{
